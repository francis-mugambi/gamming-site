...
<html>
<meta charset="utf-8">
<title>Math Game for Free</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<head>
	<link rel="stylesheet" type="text/css" href="{% static 'cssfiles/custom.css' %}">
	<link rel="stylesheet" href="{% static 'cssfiles/bootstrap.min.css' %}">
