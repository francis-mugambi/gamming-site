...
<head>
	...
	<title>Save Me Game</title>
</head>
<body>
<div>
    <img src="{% static 'images/me.png' %}" style="display: none;" id="scream"/>
    <img src="{% static 'images/cloud.png' %}" style="display: none;" id="cloud"/>
    <img src="{% static 'images/restart.png' %}" style="display: none;" id="restart"/>
</div>
...
<div id="container" style="text-align: center;padding-top:25px;">
    <canvas id="gameCanvas" width="800" height="500" style="border:1px solid #d3d3d3;background: url({% static 'images/bac.jpg' %});" onclick="playAgain()">
        Your browser does not support the HTML5 canvas tag.</canvas>
</div>
<audio style="display: none;" autoplay="autoplay">

    <source src="{% static 'audio/missyou.mp3' %}" type="audio/mpeg">
